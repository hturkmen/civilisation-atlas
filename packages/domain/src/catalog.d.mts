...
export interface View { year: number; mode: 'history' | 'known'; selectedId: string | null; selectedPolityId?: string }
...
export function parseView(params: URLSearchParams, maxYear: number, places: Place[], boundaryRecords?: {polityId: string; period: {start: number; endExclusive: number}}[]): View;
